-- Supabase Database Schema for Trilo Banking Integration
...
CREATE INDEX IF NOT EXISTS idx_transactions_user_id ON transactions(account_id) WHERE account_id IN (SELECT id FROM bank_accounts);
...
-- INSERT INTO bank_accounts (user_id, item_id, access_token, account_id, name, type, subtype, institution_id, current_balance, mask) VALUES
-- ('test_user_1', 'test_item_1', 'test_access_token_1', 'test_account_1', 'Chase Checking', 'depository', 'checking', 'chase', 2847.32, '1234'),
-- ('test_user_1', 'test_item_1', 'test_access_token_1', 'test_account_2', 'Chase Savings', 'depository', 'savings', 'chase', 12500.00, '5678');

...
export default function WeekNumberPicker({ selectedWeek, onWeekSelect }: WeekNumberPickerProps) {
  ...
  const selectedWeekLabel = weeks.find(w => w.number === selectedWeek)?.label || 'Week 1';
                ...
                >
                  <View style={styles.weekContent}>
                    ...
                    <Text style={[
                      ...
                      selectedWeek === week.number && styles.selectedWeekDescription
                    ]}>
                      {week.description}
                    </Text>
                  </View>

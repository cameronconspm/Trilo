...
export default function PayCadencePicker({
  selectedCadence,
  onCadenceSelect,
}: PayCadencePickerProps) {
  ...
  const selectedOption = cadenceOptions.find(
    option => option.key === selectedCadence
  );
      ...
      {showHelp && (
        <View style={dynamicStyles.helpContainer}>
          <Text style={dynamicStyles.helpText}>
            Choose how often you receive this income. This helps calculate when
            your next payments will arrive.
          </Text>
        </View>
      )}
                ...
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    selectedCadence === option.key &&
                      dynamicStyles.selectedOptionStyle,
                  ]}
                  ...
                  <View style={dynamicStyles.optionContent}>
                    ...
                    <Text
                      style={[
                        ...
                        selectedCadence === option.key &&
                          dynamicStyles.selectedOptionDescription,
                      ]}
                    >
                      {option.description}
                    </Text>
